...
export default function Edit({ attributes, setAttributes }) {
	...
	const current_location = window.location.href.substring(
	...
	const post_data = posts
		?.filter((post) => post.slug != current_location)
	...
	// Log the filtered posts data for debugging
	console.log("Filtered Post Data:", post_data);
	...
	return (
		<>
			...
			<section {...useBlockProps()} id="related-articles-section">
				<header>
