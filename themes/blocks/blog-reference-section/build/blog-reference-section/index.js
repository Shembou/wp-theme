...
/***/ "./src/blog-reference-section/edit.js":
/*!********************************************!*\
  !*** ./src/blog-reference-section/edit.js ***!
  \********************************************/
...
/* harmony import */ var _common_CustomButton__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../common/CustomButton */ "../common/CustomButton.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/blog-reference-section/editor.scss");
...
function Edit({
  ...
  const available_categories = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select('core').getEntityRecords('taxonomy', 'category'));
  const posts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select('core').getEntityRecords('postType', 'post', {
    per_page: -1
  }));
  const post_links = posts?.map(({
    link,
    content
  }, index) => {
    return {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Tag', 'blog-reference-section'),
            value: tag || '',
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Heading', 'blog-reference-section'),
            value: heading || '',
            onChange: value => setAttributes({
              heading: value
            })
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Paragraph', 'blog-reference-section'),
            value: paragraph || '',
            onChange: value => setAttributes({
              paragraph: value
            })
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Posts Per Page Limit', 'blog-reference-section'),
            value: posts_per_page_limit || '',
            type: "number",
            onChange: value => setAttributes({
              posts_per_page_limit: value
            })
          })
        })]
      })
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("header", {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("h3", {
            ...
            children: available_categories && available_categories.map(({
              name,
              slug
            }, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("p", {
              className: "tag",
              children: name
            }, index))
          })]
        ...
        className: "blog-posts-wrapper",
        children: post_links && post_links.slice(0, parseInt(posts_per_page_limit)).map(({
          link,
          data
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
                ...
                children: data.tags.map((tag, j) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
                  className: "tag",
                  children: tag
                }, j))
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("h2", {
                children: data.title
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(_common_CustomButton__WEBPACK_IMPORTED_MODULE_5__["default"], {
                url: link,
      ...
      className: "important",
      children: "Pagination controls only visible on frontend"
    })]
  });
}
...
/***/ "./src/blog-reference-section/index.js":
/*!*********************************************!*\
  !*** ./src/blog-reference-section/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./src/blog-reference-section/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blog-reference-section/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blog-reference-section/block.json");
/**
...
/***/ "./src/blog-reference-section/editor.scss":
/*!************************************************!*\
  !*** ./src/blog-reference-section/editor.scss ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blog-reference-section/style.scss":
/*!***********************************************!*\
  !*** ./src/blog-reference-section/style.scss ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blog-reference-section/block.json":
/*!***********************************************!*\
  !*** ./src/blog-reference-section/block.json ***!
  \***********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/blog-reference-section","version":"0.1.0","title":"Blog Reference Section","category":"theme","icon":"admin-post","description":"Blog reference section created with block scaffold.","example":{},"supports":{"html":false,"spacing":{"margin":true,"padding":true}},"textdomain":"blog-reference-section","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js","attributes":{"tag":{"type":"string"},"heading":{"type":"string"},"paragraph":{"type":"string"},"posts_per_page_limit":{"type":"string"}}}');
...
/******/ 		var installedChunks = {
/******/ 			"blog-reference-section/index": 0,
/******/ 			"blog-reference-section/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkblog_reference_section"] = globalThis["webpackChunkblog_reference_section"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blog-reference-section/style-index"], () => (__webpack_require__("./src/blog-reference-section/index.js")))
